...
class test_notificationclient(unittest.TestCase):
    def setUp(self):
        ...
        self.device_token = os.environ.get("DEVICE_TOKEN", 'fc_cpX9xQh2tDO13NhygCk:APA91bGOgTQlFZMfY366QaNr8xX0MQMqAJM6w11fzNVDmKdAZGQ_KTLyRvCYJXtLuHSOmdIRNouvhXaJqPMQG8_OGR2at4ZH4gKjdFwh5nWn6bHWWYUlNxdks9Cy76so_0pb2PLklx1B')
